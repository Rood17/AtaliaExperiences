 ...
 a.fn.twentytwenty = function (b) {
  ...
  return this.each(function () {
   ...
   var j = (d.find(".twentytwenty-overlay"), function (a) {
    ...
    k = function (a) {
     "vertical" === e ? f.css("clip", "rect(0," + a.w + "," + a.ch + ",0)") : ("0px" == a.cw && (a.cw = "0.1px"), f.css("clip", "rect(0," + a.cw + "," + a.h + ",0)")), d.css("height", a.h)
    },
    l = function (a) {
     var b = j(a);
   ...
   }), h.on("moveend", function (a) {
    d.removeClass("active")
   }), h.on("move", function (a) {
    d.hasClass("active") && (c = "vertical" === e ? (a.pageY - offsetY) / imgHeight : (a.pageX - m) / n, c < 0 && (c = 0), c > 1 && (c = 1), l(c))
